...
The olurabian.com site and its serverless functions, published from this repository. The versions that receive fixes are the latest release and the commit on the default branch.
...
The Deadlatch stack described on the site is held to the threat model in the Purse README, https://github.com/ArabianAnalyst/purse#threat-model.
